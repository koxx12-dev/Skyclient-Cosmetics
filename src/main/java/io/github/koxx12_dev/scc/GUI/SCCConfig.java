...
public class SCCConfig extends Vigilant {
    ...
    @Property(type = PropertyType.TEXT, name = "Discord RPC Second Line", description = "Allows you to set the second line of the Discord RPC", category = "Main", subcategory = "RPC")
